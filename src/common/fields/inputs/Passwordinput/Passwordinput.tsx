...
export const PasswordInput: React.FC<PasswordInputProps> = ({ value, ...props }) => {
  ...
  const EyeIcon = React.useCallback(
    () => (
      ...
      >
        <div className={showPassword ? styles.password_show_icon : styles.password_hide_icon} />
      </div>
    ),
    [showPassword]
  );
...
//       {showPasswordToggle && (
//         <div
//           className={inputStyles.password_toggle_container}
//           onClick={() => setShowPassword(!showPassword)}
//         >
//           {showPassword ? (
//             <svg
...
//   )
// }
//  Omit< React.HTMLProps<HTMLInputElement> ,'type'> Убираем type из пропа
